...
int main(int argc, char **argv)
{
    ...
    err = SERL0_Init(fd,serl_speed,serl_flow_ctrl,serl_databit,serl_stopbits,serl_parity[0]);
    ...
    len = SERL0_Send(fd,comm_result,sizeof(comm_result));
    if(len>0)
    {
